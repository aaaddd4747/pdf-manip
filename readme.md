# summary
a dead simple gui application to allow you to use a single-sided ADF scanner on a printer to scan double sided documents.

# instructions for use
1. scan the first half.
2. flip the entire document stack over and put it back in the adf scanner.
